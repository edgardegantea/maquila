                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" required
                                       id="exampleInputBorderWidth2" name="apellido_paterno" placeholder="Ejemplo: Degante">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" required
                                       id="exampleInputBorderWidth2" name="apellido_materno" placeholder="Ejemplo: Aguilar"
                                       minlength="3">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" required
                                       id="exampleInputBorderWidth2" name="fecha_nacimiento">
                            </div>
                        </div>
...
<footer class="footer mt-auto py-3">
    <div class="container text-center">
        <span class="text-muted">Developed by MAEWALLIS Corp. <?php echo date('Y'); ?>.</span>
    </div>
</footer>
